                ...
                <div class="col-md-2 p-0">
                    <div class="card">
                        ...
                        <div class="card-body my-card-body">
                            ...
                            @foreach ($tags as $tag)
                                <a href="/?tag={{ $tag->id }}"
                                    class="card-text d-block text-decoration-none  d-flex justify-content-between mb-2">{{ $tag->name }}</a>
                            @endforeach
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body my-card-body">
                            @foreach ($memos as $memo)
                                <a href="/edit/{{ $memo->id }}"
                                    class="card-text d-block text-decoration-none ellipsis mb-2">{{ $memo->content }}</a>
                            @endforeach
                        </div>
                    </div>
                </div>
